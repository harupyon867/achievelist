...
ActiveRecord::Schema[7.0].define(version: 2023_03_18_060008) do
  ...
  create_table "token_issue_events", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.text "refresh_token", null: false
    t.datetime "event_datetime", null: false
    t.index ["user_id"], name: "index_token_issue_events_on_user_id"
  end
  ...
  add_foreign_key "token_issue_events", "users"
end
